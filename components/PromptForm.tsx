...
const DEFAULT_PROMPT = `[Cena 1 – Noite chuvosa, rua deserta]
Som de trovões. Uma viatura policial estaciona diante de uma casa antiga.
A agente Lívia Torres sai do carro, com o rosto tenso.
No rádio, a voz diz:

“Tenente, o chamado veio desse endereço. A ligação durou apenas seis segundos antes de cair.”

Ela olha o celular: uma chamada perdida de um número desconhecido — 23h47.

[Cena 2 – Interior da casa, luzes piscando]
Lívia entra. O som da chuva ecoa pelas janelas.
No chão, uma xícara quebrada. Um celular tocando no silêncio.
Ela atende.

“Alô? Quem fala?”

Silêncio. Depois, uma respiração lenta.

“Você chegou tarde demais.”

O telefone cai da mão dela.

[Cena 3 – Câmera lenta]
Ela acende a lanterna e vê marcas de lama levando até o corredor.
No final, uma porta entreaberta.
Ela empurra devagar...

Uma cadeira girando sozinha, e uma foto polaroid no chão:
é ela mesma, entrando na casa — tirada minutos antes.

[Cena 4 – Som de sirene distante]
Lívia recua, confusa. O rádio chia novamente:

“Tenente, acabamos de rastrear o número da ligação... veio do seu próprio celular.”

Ela olha para o bolso — o telefone dela vibra.
Tela acende: “Ligação recebida – 23h47”

[Corte brusco – Tela preta]
Som de um tiro.
Silêncio.

Texto na tela:

“Alguns chamados não deviam ser atendidos.”`;
...
const PromptForm: React.FC<PromptFormProps> = ({
  ...
  const [prompt, setPrompt] = useState(initialValues?.prompt ?? DEFAULT_PROMPT);
